...
public class Main {
    ...
    public static void printPurchaseSums(ProductPurchaseInfo productPurchaseInfo) {
        System.out.println("Сумма без скидки: " + ProductPurchaseInfo.getPurchaseSumWithoutDiscount(productPurchaseInfo));
        System.out.println("Сумма со скидкой: " + ProductPurchaseInfo.getPurchaseSumWithDiscount(productPurchaseInfo));
    }
}